#!/usr/bin/env python3
"""Run the isolated retrospective GW12 evidence fork."""
...
from src.orchestration.evidence_fork import run_isolated_evidence_fork
...
def main() -> int:
    ...
    result = run_isolated_evidence_fork(
        season=args.season,
