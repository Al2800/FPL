# Outstanding Beads migration — map

## Notes

Former open Beads were published as local markdown tickets under
`.scratch/outstanding-beads/issues/`. Beads under `.beads/` are archive-only.

## Decisions so far

- Tickets 01–03 resolved: portable CI artifact boundary; 2025/26 ranks permanently unavailable; rank-calibration closed on unavailable branch.
- Ticket 04 resolved: 2026/27 Overall (314) standings capture approved disabled-by-default; collector + tests landed.
- Ticket 05 resolved: official citation path selected; rehearsal artifact committed; Sportradar remains off; `selected_provider` null.
